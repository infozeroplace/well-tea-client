  ...
  return (
    <div className="container px-4 lg:px-20">
      ...
      <div className="section-gap text-2xl text-center lg:text-left tracking-tight font-medium">
        ...
        right – we’re passing on everything we’ve learned, so follow our lead!​
      </div>
      ...
      <div className="section-gap">
        ...
        <p>
          ...
          blends – black, green, fruit or herbal tisanes, in either tea bags or
          loose leaf. This method can make a small jug for yourself, enough to
          share or a large batch to have in the fridge throughout the week.
        </p>
        <br />
        <p>
          Please note, our instructions below uses a WellTea Teamaker and a
          WellTea Jug-A-Lot, but if you don’t have these tools, it can easily be
          made in a regular teapot too.
        </p>
        <br />
        ...
        <p>
          ...
          concentrate, then you can add ice while maintaining that full flavour.
        </p>
        <br />
        <p>
          Customise and create your own flavours by blending different teas.
          Start experimenting by adding fruit tisanes to a black tea, or herbal
          blends to green tea, the combinations are endless.
        </p>
      </div>
      ...
      <div className="content-gap">
        ...
        <p>
          Every blend can be made into iced tea, but some work particularly well
          chilled. Black tea is famously delicious with ice, the bold taste of
          black tea leaves is softened when iced, and it mixes well with sweet
          fruits and garnishes. Fruit tisanes are our most flavour-forward
          blends, they are available in with tastes of different fruits and
          desserts. These are great for kids, and a great alternative to overly
          sweet soft drinks. Green tea is a lighter option for iced tea, it’s
          naturally slightly sweet and loved for it’s refreshing notes.
        </p>
        <br />
        <div className="flex gap-2 mb-1">
          <Image
        ...
        <p>
          When making iced black tea, a favourite in the WellTea office is Assam –
          it’s bold, malty, and slightly sweet, it’s the perfect iced tea base.
          Add a squeeze of lemon to enhance its malty flavours.
        </p>
        <br />
        <p>
          Gorgeous Geisha iced is also on regular rotation. It’s a luscious
          green tea with strawberries that add a sweet, fruity touch—perfect for
          a refreshing sip. As it is already infused with fruits, you don’t need
          to garnish this tea which makes it all the more easy to make.
        </p>
        <br />
        <p>
          Packs A Peach is an original favourite of ours for making iced tea. It
          tastes sweet and juicy, perfect for pairing with fresh peach slices
          and a sprig of mint.
        </p>
      </div>
      ...
      <div className="section-gap">
        ...
        <p>
          ...
          seal, jugs and large jars with lids are great choices. This will also
          keep the tea from picking up the taste or odors from food.​
        </p>
        <br />
        <p>

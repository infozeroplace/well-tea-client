...
const SectionLinkButton = ({
  ...
  return (
    ...
    >
      <span
        className={
          "absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 z-20 text-teagreen-700 group-hover:text-white transition-all duration-300 text-nowrap " +
          textClass
        }
      >
        {title}

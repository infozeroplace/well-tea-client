...
const discoverItems = [
  ...
  { title: "Blac Tea", image: "/images/welltea_hero.png" },
  { title: "Green Tea", image: "/images/welltea_hero.png" },
  { title: "White Tea", image: "/images/welltea_hero.png" },
  { title: "Oolong Tea", image: "/images/welltea_hero.png" },
  { title: "Matcha", image: "/images/welltea_hero.png" },
];
const TeaRange = () => {
  return (
    <div className="relative my-14">
      <div className="w-full h-[500px]">
        <Image layout="fill" src="/images/welltea_hero.png" alt="Discover" />
      </div>

...
const MatchaTeaRecipe = () => {
  const [choosOption, setChoosOption] = useState({
    title: matchaData[0].title,
    serve: matchaData[0].serve,
    need: matchaData[0].need,
    tools: matchaData[0].tools,
    steps: matchaData[0].steps,
  });

  const [selected, setSelected] = useState(matchaData[0].title);
...
export default MatchaTeaRecipe;
